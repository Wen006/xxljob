 ...
 */
public class SnowflakeIdWorker implements XxlKeyGentor<Long> {
...
//            System.out.println((Integer)id);
            System.out.print(Long.toBinaryString(id)+"  == "+Integer.parseInt(sId.substring(6))+" ==== ");

            System.out.println(id+"  ====  "+sId.length()+" == "+sId.substring(5).length());
        }
