...
public class AdminBizImpl implements AdminBiz {
    ...
    @Override
    public ReturnT<String> pause(int jobId) {
        return xxlJobService.pause(jobId);
    }

    @Override
    public ReturnT<String> add(XxlJobInfoCore xxlJobInfoCore) {
        // 需将XxlJobInfoCore 转为 XxlJobInfo
        XxlJobInfo xxlJobInfo = new XxlJobInfo();
        BeanUtils.copyProperties(xxlJobInfoCore,xxlJobInfo); //copyProperties(sourceDemo, targetDemo)
