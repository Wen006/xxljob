...
public class PermissionInterceptor extends HandlerInterceptorAdapter {
	...
	public static boolean ifLogin(HttpServletRequest request){
		String indentityInfo = request.getHeader(LOGIN_IDENTITY_KEY);		// 这个会对于财经云系统嵌入用的
		if(Objects.isNull(indentityInfo)){
			indentityInfo = CookieUtil.getValue(request, LOGIN_IDENTITY_KEY);
		}
